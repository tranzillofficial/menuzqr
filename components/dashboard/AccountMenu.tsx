  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-2 rounded-xl border border-ink-200 bg-white p-1 pr-2 text-ink-700 transition-colors hover:bg-ink-50"
      >
      ...
      {open && (
        <>
          ...
          <div
            role="menu"
            className="animate-slide-up absolute right-0 z-50 mt-2 w-60 overflow-hidden rounded-2xl border border-ink-200 bg-white shadow-xl"
          >
            <div className="border-b border-ink-100 px-4 py-3">
              <p className="truncate text-sm font-medium text-ink-900">{restaurantName ?? "No restaurant yet"}</p>
